...
//     const mapRecipes = await results.map(element =>{
//         return{
//             id: element.id,
//             name: element.title,
//             diets: element.diets,
...
//         }
//     })
//     // console.log('map recipes get data',mapRecipes[0]);
//     return mapRecipes
// }
...
const mapApi = async () => {
    ...
    // const apiData = await axios.get(allData.results);
    const mapRecipes = await apiData.data.results.map(element => {
        ...
        console.log('api data get data->', mapRecipes[0]);
    return mapRecipes
}
